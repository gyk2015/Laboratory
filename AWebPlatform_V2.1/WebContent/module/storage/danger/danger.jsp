...
<button id="creat" type="button" data-role="formControlShow1" class="btn btn-success pull-right">创建</button>
...
<div id="demo-danger" class="collapse in">
	<div class="accordion" id="accordion2">
		  ...
		  <div class="accordion-group">
		    <div class="accordion-heading">
		      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo-danger">
		        XX2存储信息
		      </a>
		    </div>
		    <div id="collapseTwo-danger" class="accordion-body collapse">
		      <div class="accordion-inner">
		        <div class=row>
		      	 	 <div class="span6">
		       		 	<h4>名称：</h4>
